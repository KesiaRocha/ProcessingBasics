  ...
  speed = 5.5; //declarando a variavel speed
  }
  ...
  posX = posX+speed;
   ...
   speed = - speed; //negativa o valor de speed, fazendo com que quique e volte, ou seja, ele vai em +5.5 e depois volta (-speed) em -5.5
    }
